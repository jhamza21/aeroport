...
export class AvionComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.avionService
      ...
      .subscribe(
        (res: HttpResponse<IAvion[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInAvions(): void {
    this.eventSubscriber = this.eventManager.subscribe('avionListModification', () => this.loadPage());
  }
