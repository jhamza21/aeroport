...
export class PersonnelComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.personnelService
      ...
      .subscribe(
        (res: HttpResponse<IPersonnel[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  ngOnInit(): void {
    ...
    this.registerChangeInPersonnel();
  }
  ...
  registerChangeInPersonnel(): void {
    this.eventSubscriber = this.eventManager.subscribe('personnelListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPersonnel[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
