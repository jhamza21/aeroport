...
import { AeroportComponent } from 'app/entities/aeroport/aeroport.component';
...
describe('Component Tests', () => {
  describe('Aeroport Management Component', () => {
    let comp: AeroportComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AeroportComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.aeroports && comp.aeroports[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
